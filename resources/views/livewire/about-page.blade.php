...
<section class="page-title overflow-hidden text-center light-bg bg-contain animatedBackground" data-bg-img="{{ asset('assets/images/pattern/05.png') }}">
  ...
  <!--about start-->
    <section data-bg-img="images/pattern/02.png">
            ...
            <div class="col-lg-6 col-md-12 order-lg-1">
              <div class="row">
                ...
                <div class="col-md-6 mt-4 mb-4">
                  <div class="image-block">
                    <img class="img-fluid box-shadow radius w-100" src="{{ asset('assets/images/about/05.jpg') }}" alt="">
                  </div>
                </div>
                <div class="col-md-6 sm-mt-3">
                  <div class="image-block">
                    <img class="img-fluid box-shadow radius w-100" src="{{ asset('assets/images/about/06.jpg') }}" alt="">
                  </div>
                </div>
                <div class="col-md-6 mt-4">
                  <div class="image-block">
                    <img class="img-fluid box-shadow radius w-100" src="{{ asset('assets/images/about/07.jpg') }}" alt="">
                  </div>
                </div>
              </div>
            </div>
      ...
      <section class="overflow-hidden dark-bg custom-pb-18 animatedBackground" data-bg-img="{{ asset('assets/images/pattern/06.png') }}">
        <div class="container mb-5">
        ...
        <div class="container-fluid p-0">
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <div class="owl-carousel owl-center" data-items="4" data-md-items="2" data-sm-items="2" data-center="true" data-dots="false" data-nav="true" data-autoplay="true">
                <div class="item">
